...
public class SsUsuarios {
    ...
    private HashMap<String, Jugador> usuariosRegistrados = new HashMap<>();
    private HashMap<String, Jugador> usuariosLogueados = new HashMap<>();
    ...
    public Jugador ingresar(String nombreUsuario, String contrasena)
            throws Exception {
        Jugador jugadorRegistrado = usuariosRegistrados.get(nombreUsuario);
